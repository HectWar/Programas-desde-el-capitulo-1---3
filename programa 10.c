...
// Busqueda secuencia de arreglos ordenados en dorma creciente.
...
//Se llama a la funcion que busca en el arreglo.
...
//Si se encuentra, la funcion regresa la posicion correspondiente. En caso contrario regrese a 0.
{
    int RES, I = 0, BAN = 0;
    while ((I < T) && (E >= A[I]) && !BAN)
